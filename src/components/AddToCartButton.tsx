    ...
    return (
      <form onSubmit={handleSubmit} className="flex items-center gap-3 w-full sm:w-auto" data-no-progress data-no-loading>
        ...
        <select
          ...
          name="qty"
          defaultValue="1"
          className="h-11 rounded-lg border border-gray-300 bg-white text-gray-900 px-3.5 text-sm focus:border-primary focus:outline-none cursor-pointer shadow-sm"
        >
