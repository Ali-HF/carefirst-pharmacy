  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
      <div className="flex items-center justify-between mb-8">
        ...
        <Link
          href="/admin"
          className="min-h-[44px] px-4 py-2 inline-flex items-center justify-center rounded-full ring-1 ring-ink/20 text-sm hover:ring-oxblood transition-colors"
          style={{ fontFamily: "var(--font-stamp)" }}
        >
          ← INVENTORY
        </Link>
      ...
      {orders.length === 0 ? (
        ...
        <ul className="divide-y divide-ink/10">
          {orders.map((o) => (
            <li key={o.id} className="py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div>
